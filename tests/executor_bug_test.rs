...
fn test_nested_main_thread_submit_bug() -> bool {
    ...
    if let Some((final_count, log)) = result.as_ref() {
        ...
        if !success {
            println!("  FAILED: count_ok={}, outer_start_ok={}, inner_exec_ok={}, outer_after_ok={}", 
...
fn test_deep_nested_submissions() -> bool {
    ...
    
    {
        ...
        println!("  Deep nested test - Final completion count: {}", final_count);
...
fn test_concurrent_submissions() -> bool {
    ...
    
    {
        ...
        println!("  Concurrent test - Final completion count: {}", final_count);
